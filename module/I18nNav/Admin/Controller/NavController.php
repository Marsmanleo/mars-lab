...
namespace Module\I18nNav\Admin\Controller;
...
use Module\I18nNav\Type\NavOpenType;
use Module\I18nNav\Type\NavPosition;
use Module\I18nNav\Util\NavUtil;
...
class NavController extends Controller
{
    ...
    protected function crud(AdminCRUDBuilder $builder)
    {
        if ($builder->mode() == AdminCRUDBuilder::MODE_FORM) {
            ...
            ModStart::scriptFile('module/I18nNav/Admin/Controller/NavEdit.js');
        }
        $builder
            ->init('nav_i18n')
        ...
        $builder
            ->hookSaved(function (Form $form) {
                ...
                $item = $form->item();
                if ($item->pid > 0) {
                    $parent = ModelUtil::get('nav_i18n', $item->pid);
                    ModelUtil::update('nav_i18n', $item->id, [
