...
@section('memberBodyContent')
    ...
    <div class="tw-bg-white tw-rounded-lg margin-bottom mars-info">
    ...
    <div class="tw-bg-white tw-rounded-lg margin-bottom quick-menu">
        <div class="row">
            <div class="col-md-2 col-4 other-col">
                <a href="{{modstart_web_url('member_message')}}">
                <img src="@asset('vendor/Site/image/quick-message.svg')" />
                <p>我的消息</p>
                </a>
            </div>
            <div class="col-md-2 col-4 other-col">
                <a href="{{modstart_web_url('member_profile/avatar')}}">
                <img src="@asset('vendor/Site/image/quick-info.svg')" />
                <p>我的资料</p>
                </a>
            </div>
            <div class="col-md-2 col-4 other-col">
                <a href="{{modstart_web_url('member_profile/password')}}">
                <img src="@asset('vendor/Site/image/quick-password.svg')" />
                <p>修改密码</p>
                </a>
            </div>
            <div class="col-md-2 col-4 other-col">
                <a href="{{modstart_web_url('member_profile/avatar')}}">
                <img src="@asset('vendor/Site/image/quick-avatar.svg')" />
                <p>修改头像</p>
                </a>
            </div>
            <div class="col-md-2 col-4 view-pc">
                <a class="sub-nav-item" href="javascript:;"
                   data-href="{{modstart_web_url('logout')}}" data-confirm="确认退出登录？">
                <img src="@asset('vendor/Site/image/quick-logout.svg')" />
                <p>退出登录</p>
                </a>
            </div>
        </div>
