        ...
        <form action="{{\ModStart\Core\Input\Request::currentPageUrl()}}" class="ub-form" method="post" style=" " data-ajax-form>
            ...
            @if($_memberUser['email'] && $_memberUser['emailVerified'])
                ...
                <div data-modify-box style="display:none;">
                    <div class="line">
                        ...
                        <div class="field">
                            <input type="text" class="form" name="email" value="" placeholder="新邮箱"/>
                        </div>
                    </div>
                    <div class="line">
                        ...
                        <div class="field">
                            <div class="row">
                                <div class="col-6">
                                    <input class="form" type="text" name="captcha" placeholder="图形验证码"/>
                                </div>
                                <div class="col-6">
                                    <img data-captcha src="{{$__msRoot}}member_profile/captcha"   class="captcha" alt="刷新验证码" onclick="this.src='{{$__msRoot}}member_profile/captcha?'+Math.random();"/>
                                </div>
                            </div>
                            <div class="help">
                            </div>
                    ...
                    <div class="line">
                        ...
                        <div class="field">
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form" name="verify" placeholder="邮箱验证码"/>
                                </div>
                                <div class="col-6">
            ...
            @else
                ...
                <div class="line">
                    <div class="label">邮箱:</div>
                    <div class="field">
                        <input type="text" class="form" name="email" value="{{empty($_memberUser['email'])?'':$_memberUser['email']}}" placeholder="邮箱"/>
                    </div>
                </div>
                <div class="line">
                    <div class="label">图形验证：</div>
                    <div class="field">
                        <div class="row">
                            <div class="col-6">
                                <input type="text" class="form" name="captcha" placeholder="图形验证码"/>
                            </div>
                            <div class="col-6">
                                <img data-captcha src="{{$__msRoot}}member_profile/captcha" class="captcha" alt="刷新验证码" onclick="this.src='{{$__msRoot}}member_profile/captcha?'+Math.random();"/>
                            </div>
