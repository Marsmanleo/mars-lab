        ...
        <form action="{{\ModStart\Core\Input\Request::currentPageUrl()}}" class="ub-form" method="post" style=" " data-ajax-form>
            ...
            @if($_memberUser['phone'] && $_memberUser['phoneVerified'])
                ...
                <div data-modify-box style="display:none;">
                    <div class="line">
                        ...
                        <div class="field">
                            <input type="text" class="form" name="phone" value="" placeholder="手机号"/>
                        </div>
                    </div>
                    <div class="line">
                        ...
                        <div class="field">
                            <div class="row">
                                <div class="col-6">
                                    <img class="captcha" data-captcha src="{{$__msRoot}}member_profile/captcha" style="width:100%;border:1px solid #CCC;border-radius:3px;cursor:pointer;" alt="刷新验证码" onclick="this.src='{{$__msRoot}}member_profile/captcha?'+Math.random();"/>
                                </div>
                                <div class="col-6">
                                    <input class="form" type="text" name="captcha"  placeholder="图像验证码"/>
                                </div>
                    ...
                    <div class="line">
                        ...
                        <div class="field">
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form" name="verify"  placeholder="手机验证码"/>
                                </div>
                                <div class="col-6">
            ...
            @else
                ...
                <div class="line">
                    <div class="label">手机:</div>
                    <div class="field">
                        <input type="text" class="form" name="phone" value="{{ empty($_memberUser['phone']) ? '' : $_memberUser['phone'] }}" placeholder="手机号"/>
                    </div>
                </div>
                <div class="line">
                    <div class="label">图形验证：</div>
                    <div class="field">
                        <div class="row">
                            <div class="col-6">
                                <input type="text" class="form" name="captcha" placeholder="图像验证码"/>
                            </div>
                            <div class="col-6">
                                <img  class="captcha" data-captcha src="{{$__msRoot}}member_profile/captcha" alt="刷新验证码" onclick="this.src='{{$__msRoot}}member_profile/captcha?'+Math.random();"/>
                            </div>
                        </div>
                    </div>
                </div>
