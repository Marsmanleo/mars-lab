...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    public function boot(Dispatcher $events)
    {
        ...
        if (modstart_module_enabled('Banner')) {
            ...
            BannerPositionBiz::registerQuick('Cms-m', '手机首页');
            BannerPositionBiz::registerQuick('Brand1', 'loading页面');
            BannerPositionBiz::registerQuick('Brand1-m', 'loading页面【手机】');
        }
        if (modstart_module_enabled('Banner')) {
            PartnerPositionBiz::registerQuick('Cms', 'CMS系统');
            PartnerPositionBiz::registerQuick('Cms-m', '手机首页');
            PartnerPositionBiz::registerQuick('Brand1', 'loading页面');
            PartnerPositionBiz::registerQuick('Brand1-m', 'loading页面【手机】');
        }
